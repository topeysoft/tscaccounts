...
ApiMessages.COULD_NOT_SAVE_TOKEN = 100;

ApiMessages.UPDATED = 1000;
ApiMessages.NOT_CHANGED = 1001;
ApiMessages.INVALID_OPERATION = 1002;
ApiMessages.ALREADY_EXISTS = 1004;
ApiMessages.COULD_NOT_CREATE = 1005;
